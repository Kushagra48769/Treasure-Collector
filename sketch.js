...
var pathImg,boyImg,cashImg,diamondsImg,jwelleryImg,swordImg,endImg,boyI;
...
function preload(){
  ...
  boyI = loadAnimation("runner1.png");
  ...
  if(path.y > height ){
    ...
    if (cashG.isTouching(boy)) {
      ...
      treasureCollection = treasureCollection+100
        ...
        boy.destroy();
        path.velocityY = 0;
        boy.addAnimation("SahilRunning", boyI);
   }
